...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with infinite turns (turns <= 0) were not being re-enqueued correctly.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with infinite turns (turns == 0) were not re-enqueued. Their turns were not preserved.
    ...
    // Defect(s) Found: No defects. Exception thrown correctly when queue is empty.
